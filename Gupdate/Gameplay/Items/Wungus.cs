...
namespace Gupdate.Gameplay.Items
{
    public class Wungus : ModBehaviour
    {
        ...
        public override (string, string)[] GetLang() => new[]
        {
            ...
            ("ITEM_MUSHROOMVOID_DESC", "On killing an enemy, boost <style=cIsHealing>base health regeneration</style> by <style=cIsHealing>+1.5 hp/s</style> for <style=cIsUtility>1s (+1s per stack)</style> and refresh all current boosts."),
        };
